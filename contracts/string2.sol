...
contract string2 { 
	...
	mapping(uint =>string_2) public facts;

	function addFact(string key_1,string key_2) public returns (string ,string , uint ID){
	...
	function getFact(uint id) public constant returns (string key_1,string key_2, uint timestamp){
