...
contract int5 { 
	...
	mapping(uint =>int_5) public facts;

	function addFact(uint key_1,uint key_2,uint key_3,uint key_4,uint key_5) public returns (uint ,uint ,uint ,uint ,uint , uint ID){
	...
	function getFact(uint id) public constant returns (uint key_1,uint key_2,uint key_3,uint key_4,uint key_5, uint timestamp){
