...
contract int3 { 
	...
	mapping(uint =>int_3) public facts;

	function addFact(uint key_1,uint key_2,uint key_3) public returns (uint ,uint ,uint , uint ID){
	...
	function getFact(uint id) public constant returns (uint key_1,uint key_2,uint key_3, uint timestamp){
