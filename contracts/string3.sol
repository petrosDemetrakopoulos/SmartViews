...
contract string3 { 
	...
	mapping(uint =>string_3) public facts;

	function addFact(string key_1,string key_2,string key_3) public returns (string ,string ,string , uint ID){
	...
	function getFact(uint id) public constant returns (string key_1,string key_2,string key_3, uint timestamp){
