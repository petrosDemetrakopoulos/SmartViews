...
contract _bytes4 { 
	...
	mapping(uint =>bytes_4) public facts;

	function addFact(bytes32 key_1,bytes32 key_2,bytes32 key_3,bytes32 key_4) public returns (bytes32 ,bytes32 ,bytes32 ,bytes32 , uint ID){
	...
	function getFact(uint id) public constant returns (bytes32 key_1,bytes32 key_2,bytes32 key_3,bytes32 key_4, uint timestamp){
