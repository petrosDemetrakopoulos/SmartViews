...
contract string5 { 
	...
	mapping(uint =>string_5) public facts;

	function addFact(string key_1,string key_2,string key_3,string key_4,string key_5) public returns (string ,string ,string ,string ,string , uint ID){
	...
	function getFact(uint id) public constant returns (string key_1,string key_2,string key_3,string key_4,string key_5, uint timestamp){
