...
contract int1 { 
	...
	mapping(uint =>int_1) public facts;

	function addFact(uint key_1) public returns (uint , uint ID){
	...
	function getFact(uint id) public constant returns (uint key_1, uint timestamp){
